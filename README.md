...
- **Ventas del día (vendedor):** lista las ventas del día en curso hechas por el vendedor que tiene la sesión abierta (no las de los demás), ordenadas de la más reciente a la más antigua. Cada tarjeta muestra hora, tipo de venta, total y el detalle de productos vendidos en esa venta. Se actualiza con el botón "🔄 Actualizar" o al abrir la pestaña (no funciona sin conexión).
